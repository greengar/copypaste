...
@implementation NSData (WBBase64)
...
+ (NSData *)wbDataFromBase64String:(NSString *)aString
{
	...
	size_t outputLength;
	void *outputBuffer = WBNewBase64Decode([data bytes], [data length], &outputLength);
...
{
	size_t outputLength;
	char *outputBuffer = WBNewBase64Encode([self bytes], [self length], true, &outputLength);
