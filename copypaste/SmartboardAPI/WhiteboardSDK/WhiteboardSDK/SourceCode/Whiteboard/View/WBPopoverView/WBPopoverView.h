...
- (void)popoverView:(WBPopoverView *)popoverView didSelectItemAtIndex:(NSInteger)index;
...
@interface WBPopoverView : UIView {
    ...
    __WEAK id<WBPopoverViewDelegate> delegate;
...
@property (nonatomic, WEAK) id<WBPopoverViewDelegate> delegate;

#pragma mark - Class Static Showing Methods

//These are the main static methods you can use to display the popover.
//Simply call [WBPopoverView show...] with your arguments, and the popover will be generated, added to the view stack, and notify you when it's done.
...
//Lays out the WBPopoverView at a point once all of the views have already been setup elsewhere
- (void)layoutAtPoint:(CGPoint)point inView:(UIView *)view;

#pragma mark - Other Interaction
//This method animates the rotation of the WBPopoverView to a new point
