...
@implementation GSSVProgressHUD
...
+ (GSSVProgressHUD*)sharedView {
    static dispatch_once_t once;
    static GSSVProgressHUD *sharedView;
...
+ (void)showImage:(UIImage *)image status:(NSString *)string {
    NSTimeInterval displayInterval = [[GSSVProgressHUD sharedView] displayDurationForString:string];
...
- (void)positionHUD:(NSNotification*)notification {
    ...
    if(notification) {
        GSSVProgressHUD *__weak weakSelf=self;
