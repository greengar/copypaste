...
- (void) initializeColorSpectrumWithFrame:(CGRect)frame {
    ...
    self.colorPickerTitleBar = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Whiteboard.bundle/ColorPickerTitleBar.png"]];
...
- (void) initializeBrushToolViewWithFrame:(CGRect)frame {
    UIImageView *brushToolsBackground = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Whiteboard.bundle/BrushToolBackground.png"]];
