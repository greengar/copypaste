...
#import "WBPopoverView_Configuration.h"
#import <QuartzCore/QuartzCore.h>

#define kAnimationDurationDismiss 0.1f //0.3f
#define kAnimationDurationShow 0.1f //0.2f
#define kAnimationDurationHideActivityIndicator 0.05f //0.1f
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withText:(NSString *)text delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withText:(NSString *)text delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withViewArray:(NSArray *)viewArray delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withViewArray:(NSArray *)viewArray delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withStringArray:(NSArray *)stringArray delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withStringArray:(NSArray *)stringArray delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withStringArray:(NSArray *)stringArray withImageArray:(NSArray *)imageArray delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withStringArray:(NSArray *)stringArray withImageArray:(NSArray *)imageArray delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withContentView:(UIView *)cView delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
+ (WBPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView delegate:(id<WBPopoverViewDelegate>)delegate {
    WBPopoverView *popoverView = [[WBPopoverView alloc] initWithFrame:CGRectZero];
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView {
    ...
    [UIView animateWithDuration:kAnimationDurationShow delay:0.f options:UIViewAnimationOptionCurveEaseInOut animations:^{
        self.alpha = 1.f;
...
- (void)showActivityIndicatorWithMessage:(NSString *)msg
{
    ...
    if (subviewsArray && (subviewsArray.count > 0)) {
        [UIView animateWithDuration:kAnimationDurationShow animations:^{
...
- (void)hideActivityIndicatorWithMessage:(NSString *)msg
{
    ...
    [UIView animateWithDuration:kAnimationDurationHideActivityIndicator animations:^{
...
- (void)showImage:(UIImage *)image withMessage:(NSString *)msg
{
    ...
    [UIView animateWithDuration:kAnimationDurationShow delay:0.2f options:UIViewAnimationOptionCurveEaseOut animations:^{
        imageView.alpha = 1.f;
...
- (void)dismiss:(BOOL)animated
{
    ...
    {
        [UIView animateWithDuration:kAnimationDurationDismiss animations:^{
            self.alpha = 0.1f;
            self.transform = CGAffineTransformMakeScale(0.1f, 0.1f);
        } completion:^(BOOL finished) {
            [self dismissComplete];
